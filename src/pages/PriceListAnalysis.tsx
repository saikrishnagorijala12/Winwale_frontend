...
export default function PriceListAnalysis() {
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Select Client or Contract</h3>
              </div>
              <p className="text-sm text-slate-500">Choose the client whose pricelist you want to analyze</p>
            </div>
            <div className="p-6 space-y-6">
              <div className="space-y-3">
                <label className="text-sm font-medium text-slate-700">Client / Contract</label>
                <select 
                  value={selectedClient} 
                  onChange={(e) => setSelectedClient(e.target.value)}
                  className="w-full h-12 px-4 rounded-lg border border-slate-300 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900">Upload Commercial Pricelist</h3>
              </div>
              <p className="text-sm text-slate-500">Upload the updated commercial pricelist (Excel format)</p>
            </div>
            <div className="p-6 space-y-6">
              <div 
                className={`border-2 border-dashed rounded-xl p-12 text-center transition-colors cursor-pointer ${
                  uploadedFile ? 'border-emerald-500 bg-emerald-50' : 'border-slate-300 hover:border-cyan-500 hover:bg-cyan-50/50'
                }`}
                ...
                {uploadedFile ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Excel files (.xlsx, .xls) up to 50MB</p>
                    </div>
                  </div>
                )}
              </div>
        ...
        return (
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-200">
              ...
              <p className="text-sm text-slate-500">Compare the uploaded pricelist with the existing GSA contract data</p>
            </div>
            <div className="p-6 space-y-6">
              <div className="p-6 rounded-xl bg-slate-50 border border-slate-200">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="font-medium text-slate-900">{mockClients.find(c => c.id === selectedClient)?.name}</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-500 mb-1">Contract</p>
                    <p className="font-medium text-slate-900">{mockClients.find(c => c.id === selectedClient)?.contract}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-sm text-slate-500 mb-1">Current Products</p>
                    <p className="font-medium text-slate-900">{mockClients.find(c => c.id === selectedClient)?.products.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              ...
              {isAnalyzing && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500">Analyzing pricelist...</span>
                    <span className="font-medium text-slate-900">{analysisProgress}%</span>
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-slate-900">{mockResults.additions.length}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-slate-900">{mockResults.deletions.length}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-slate-900">{mockResults.priceIncreases.length}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-slate-900">{mockResults.priceDecreases.length}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-slate-900">{mockResults.descriptionChanges.length}</p>
                ...
                <div className="grid grid-cols-5 gap-2 mb-4 p-1 bg-slate-100 rounded-lg">
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                      activeTab === 'additions' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setActiveTab('deletions')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                      activeTab === 'deletions' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setActiveTab('priceIncreases')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                      activeTab === 'priceIncreases' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setActiveTab('priceDecreases')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                      activeTab === 'priceDecreases' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    onClick={() => setActiveTab('descriptionChanges')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                      activeTab === 'descriptionChanges' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <div className="border border-slate-200 rounded-lg overflow-hidden">
                    <table className="w-full text-sm">
                      <thead className="bg-slate-50">
                        <tr>
                          <th className="text-left p-3 font-medium text-slate-700">Part Number</th>
                          <th className="text-left p-3 font-medium text-slate-700">Product Name</th>
                          <th className="text-right p-3 font-medium text-slate-700">GSA Price</th>
                          <th className="text-right p-3 font-medium text-slate-700">Commercial Price</th>
                          <th className="text-right p-3 font-medium text-slate-700">Discount</th>
                        </tr>
                      </thead>
                      <tbody>
                        {mockResults.additions.map((item, i) => (
                          <tr key={i} className="border-t border-slate-200 hover:bg-slate-50">
                            <td className="p-3 font-mono text-xs text-slate-600">{item.partNumber}</td>
                            <td className="p-3 text-slate-900">{item.productName}</td>
                            <td className="p-3 text-right font-medium text-slate-900">{item.gsaPrice}</td>
                            <td className="p-3 text-right text-slate-500">{item.commercialPrice}</td>
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-slate-50">
                        <tr>
                          <th className="text-left p-3 font-medium text-slate-700">Part Number</th>
                          <th className="text-left p-3 font-medium text-slate-700">Product Name</th>
                          <th className="text-right p-3 font-medium text-slate-700">Old Price</th>
                          <th className="text-right p-3 font-medium text-slate-700">New Price</th>
                          <th className="text-right p-3 font-medium text-slate-700">Change</th>
                        </tr>
                      </thead>
                      <tbody>
                        {mockResults.priceIncreases.map((item, i) => (
                          <tr key={i} className="border-t border-slate-200 hover:bg-slate-50">
                            <td className="p-3 font-mono text-xs text-slate-600">{item.partNumber}</td>
                            <td className="p-3 text-slate-900">{item.productName}</td>
                            <td className="p-3 text-right text-slate-500">{item.oldPrice}</td>
                            <td className="p-3 text-right font-medium text-slate-900">{item.newPrice}</td>
                            <td className="p-3 text-right">
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-slate-50">
                        <tr>
                          <th className="text-left p-3 font-medium text-slate-700">Part Number</th>
                          <th className="text-left p-3 font-medium text-slate-700">Product Name</th>
                          <th className="text-left p-3 font-medium text-slate-700">Old Description</th>
                          <th className="text-left p-3 font-medium text-slate-700">New Description</th>
                          <th className="text-right p-3 font-medium text-slate-700">GSA Price</th>
                        </tr>
                      </thead>
                      <tbody>
                        {mockResults.descriptionChanges.map((item, i) => (
                          <tr key={i} className="border-t border-slate-200 hover:bg-slate-50">
                            <td className="p-3 font-mono text-xs text-slate-600">{item.partNumber}</td>
                            <td className="p-3 text-slate-900">{item.productName}</td>
                            <td className="p-3 text-slate-500 text-xs">{item.oldDescription}</td>
                            <td className="p-3 text-slate-900 text-xs">{item.newDescription}</td>
                            <td className="p-3 text-right font-medium text-slate-900">{item.gsaPrice}</td>
                          </tr>
                        ))}
                      </tbody>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 p-6 lg:p-10 space-y-10">
      {/* Header */}
          ...
          <div key={step.id} className="flex items-center">
            ...
            >
              ...
              <div className="hidden sm:block">
                <p className="text-xs font-bold uppercase tracking-widest leading-none">{step.title}</p>
              </div>
            </div>
