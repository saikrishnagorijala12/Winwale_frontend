...
export default function UnifiedAdminDashboard() {
  ...
  const pendingUsers = usersList.slice(0, 2);
  ...
  const stats = [
    ...
    },
    {
      ...
      value: clientStats.approved.toString(),
      icon: CheckCircle2,
    },
    {
            ...
            {loading ? (
              Array(5)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-4 rounded-2xl border border-transparent bg-slate-50/50"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div className="flex border-b border-slate-50">
              <button
                ...
                className={`flex-1 py-4 text-[10px] font-black uppercase tracking-widest transition-all relative ${adminTab === "users"
                  ? "text-[#24548f]"
              ...
              <button
                ...
                className={`flex-1 py-4 text-[10px] font-black uppercase tracking-widest transition-all relative ${adminTab === "clients"
                  ? "text-emerald-600"
                  : "text-slate-400 hover:text-slate-600"
                  }`}
              >
