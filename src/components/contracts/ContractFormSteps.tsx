// src/components/contracts/ContractFormSteps.tsx
import React, { useRef } from "react";
import { ClientContractCreate, ClientListRead, FormErrors } from "../../types/contract.types";
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
      <div className="md:col-span-2">
        <label className="text-sm font-bold text-slate-700">Contract Number <span className="text-red-500">*</span></label>
        <input
          type="text"
          className={`w-full mt-2 px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-[#38A1DB]"
          } outline-none`}
          value={contract.contract_number}
          onChange={(e) => onChange({ ...contract, contract_number: e.target.value })}
        />
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ ...contract, normal_delivery_time: parseInt(e.target.value) || 0 })
          }
        />
      </div>
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ ...contract, expedited_delivery_time: parseInt(e.target.value) || 0 })
          }
        />
      </div>
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          onChange={(e) => onChange({ ...contract, q_v_discount: e.target.value })}
        />
      </div>
      <div className="md:col-span-2">
