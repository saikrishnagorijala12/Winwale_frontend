      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto custom-scrollbar">
          {visibleNavItems.map((item) => (
            <NavLink
              ...
              onClick={() => setOpen(false)}
              className={({ isActive }) =>
                `group flex items-center gap-3.5 px-6 py-3 transition-all duration-200 relative ${
                  isActive
        ...
        <div className="p-4 bg-slate-50/50 border-t border-slate-200">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-200 shadow-sm mb-3">
            <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#c3d7e7] to-[#a3c1da] flex items-center justify-center">
